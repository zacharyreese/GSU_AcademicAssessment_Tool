...
<body>
	...
	<div class="courseList">
		<h1>${course.department} ${course.courseNumber} Learning Outcomes</h1>
		<hr>
		...
		<form action="mainServlet" method="Post">
			<div>
				<ol>
					<#if learningOutcomes??>
                <#list learningOutcomes as outcome>
			...
			<button type="submit" name="gotoNewLearningOutcome"
				value="${course.id}">Add New Learning Outcome</button>
		</form>
